            ...
            <form action="/" id="search-section" class="columns p-center full-w">
                <div class="column">
                    <div id="search-location" class="level is-mobile">
                        <label @click="address = ''; addDeliveryInformations()" for="search-location-input"
                               class="input__form__icon-before__container p-rel cpointer">
                            <span class="input__form__icon-before__container__icon-localisation dblock p-center"></span>
                        </label>
                        <input ref="autocomplete" id="search-location-input" v-model="address"
                               @focus="showHours = false" @input="addDeliveryInformations"
                ...
                <div class="column">
                    <div id="search-time" class="level is-mobile">
                        <label @click="time = []; addDeliveryInformations()" for="search-time-input"
                               class="input__form__icon-before__container p-rel cpointer">
                        ...
                        <div v-if="showHours" class="showHours">
                            <ul>
                                <li class="pd1 cpointer"
                                    @click="addDate($event); addDeliveryInformations(); showHours = !showHours"
